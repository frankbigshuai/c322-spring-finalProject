...
const host_remote = "https://demo-latest-470u.onrender.com/";
...
async function updateTheNavigationBar() {
  const navigation = document.getElementsByClassName("header-nav")[0];
  ...
  if (configuration.isLoggedIn()) {
    ...
    loginTag.innerHTML = `<li>
    <a href="login.html"><i class="fa-solid fa-user"></i></a></li>
  </li>`;
  }
}
